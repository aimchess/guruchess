  ...
  return (
    <section className="relative w-full h-[85vh] md:h-[100vh] flex flex-col items-center justify-center overflow-hidden">
      ...
      <div className="absolute inset-0 z-0">
        <img 
          src="/course.jpg" 
          alt="Guru Chess Academy Coaches" 
      ...
      <div className="relative z-10 container mx-auto px-6 text-center text-white space-y-6">
        ...
        >
          Expert Mentorship • FIDE Certified Team
        </motion.p>
        ...
        <motion.h1 
          ...
          className="text-5xl md:text-8xl font-serif tracking-tight leading-[1.1] max-w-5xl mx-auto italic"
        >
          Learn from the <br /> 
          <span >Masters of Chess.</span>
        </motion.h1>
        ...
        >
          Mentorship from International Rated players and State Champions 
      ...
      {/* 3. BOTTOM TRUST BAR (Coach Credentials Focused) */}
        ...
        <div className="container mx-auto px-6">
          <div className="flex justify-center items-center gap-12 text-white/70 uppercase text-[10px] font-black tracking-[0.2em]">
            ...
            <div className="flex items-center gap-3 group hover:text-white transition-colors cursor-default">
              <Award size={18} style={{ color: brandOrange }} />
              <span>International Rated Players</span>
            </div>

            <div className="h-4 w-px bg-white/20" />

            <div className="flex items-center gap-3 group hover:text-white transition-colors cursor-default">
              <ShieldCheck size={18} style={{ color: brandOrange }} />
              <span>FIDE Training Standards</span>
            </div>

            <div className="h-4 w-px bg-white/20" />

            <div className="flex items-center gap-3 group hover:text-white transition-colors cursor-default">
              <Zap size={18} style={{ color: brandOrange }} />
              <span>Pedigree Excellence</span>
            </div>
